...
export const TopItem = () => {
  return (
    <>
      {/*Top Item*/}
      <div className='w-335 h-76 ml-1 border-b border-gray7'>

      {/*Top Position*/}
          <div className='flex justify-center w-32 h-32 translate-x-11 translate-y-22 '>

              {/*frame 971*/}
                      <div className='flex w-10 h-23  font-trebuchet text-20 text-orange1'>
                          1
                      </div>
          </div>

      {/*frame 970*/}
          <div className='flex w-187 h-34 translate-x-50 -translate-y-11  '>

                 {/*frame 970*/}
                      <div className='grid  justify-center w-34 h-34   '>
                          <svg className='mt-5' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className='  -mt-3 '>
                          <div className=' grid w-145  h-16 ml-10 font-trebuchet font-bold text-14 text-gray1'>Anna Pacheco</div>
                          <div className=' grid w-145 h-12 ml-10 text-10 mt-5 font-verdana text-gray2 '>Consultor SWIT</div>
                      </div>
          </div>

      {/*frame 967*/}
          <div className='grid w-80 h-36 translate-x-245 -translate-y-51   '>
          {/*frame 966*/}  
              <div className='grid grid-flow-col items-center w-80 h-20 '>
              ...
              <div className=' text-10 text-gray1 mt-1 ml-5 font-verdana'>
                  Productividad
              </div>
          </div>
  </div>
