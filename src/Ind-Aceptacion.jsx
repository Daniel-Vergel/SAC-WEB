            ...
            <div className=' grid absolute grid-flow-col translate-y-64 w-440 h-152 ml-10  '>
                ...
                {/*frame 1129*/}
                    <div className='grid w-272 h-151 ml-13 '>
                        ...
                        {/*frame 13*/}
                            <div className=' grid w-272 h-95 -mt-7   '>

                            {/*frame 7*/}
                                <div className='grid grid-flow-col w-272 h-19 mb-4 font-trebuchet font-bold text-16   '>
                                        <p className='  '>Total de Actividades asignadas</p>
                            ...
                            {/*frame 10*/}
                                <div className=' grid grid-flow-col w-272 h-19 font-trebuchet text-14 text-gray2'>
                                    ...
                                    <div className=" absolute translate-y-2 w-14 h-14 rounded-full bg-blue4"></div>                             
                                        <p className=' grid ml-6 tracking-1 '>Aceptado </p>
                                        <p className=' grid justify-end tracking-1'> 118 </p>
                                </div>
                            ...
                            <div className=' grid grid-flow-col w-272 h-19 font-trebuchet text-14 text-gray2'>
                                        ...
                                        <div className=" absolute translate-y-2 w-14 h-14 rounded-full bg-red1"></div>                             
                                            <p className=' grid ml-6 tracking-1 '>Rechazado </p>
                                            <p className=' grid justify-end tracking-1'> 20 </p>
                                    </div>
                            ...
                            <div className=' grid grid-flow-col w-272 h-19 font-trebuchet text-14 text-gray2'>
                                        ...
                                        <div className=" absolute translate-y-2 w-14 h-14 rounded-full bg-orange2"></div>                             
                                            <p className=' grid ml-6 tracking-1 '>Rechazado por vencimiento </p>
                                            <p className=' grid justify-end tracking-1'> 10 </p>
                                    </div>
