...
import { IndProductividad } from './Ind-Productividad'
import { IndAceptacion } from './Ind-Aceptacion'
import { CalifDelCliente } from './Calif-Del-Cliente'
...
export const ReportedeEfectividad = () => {
  return (
    <>
    {/*Frame 1141*/}
        <div className=' absolute grid w-1297 h-325 ml-56 translate-y-312 border-2 border-gray3 rounded-10 '>

        {/*Frame 1015*/}
            <div className=' grid grid-flow-col w-1277 h-40 ml-10 mt-10 '>
            ...
            <div className=' grid  justify-end'>
                <div className='grid grid-flow-col items-center w-188 h-40 border-b border-t border-l border-r border-gray3 rounded-5 '>
                    <p className=' font-roboto text-16 text-gray8 translate-x-21 '> Ultimos 3 meses </p>
